 ...
 * ldr_parse.c
 *
 * Parse one packed loader image into heap-owned module metadata.
 *
 * The parser validates the on-disk layout, resolves string-table offsets, and
 * copies table entries into writable loader-owned structures used by later load
 * stages.
 */
