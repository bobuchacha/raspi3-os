...
/* Character sink used by the formatting helpers. */
typedef void (*putcf)(void*, char);
/* Active character output callback selected by init_printf. */
static putcf stdout_putf;
/* Opaque context forwarded back into stdout_putf. */
...
/* Convert an unsigned long long value into an ASCII string in the chosen base. */
...
/* Convert a signed long value into decimal ASCII, including a leading minus. */
...
/* Convert an unsigned int value into an ASCII string in the chosen base. */
...
/* Convert a signed int value into decimal ASCII, including a leading minus. */
...
/* Translate one hexadecimal digit character into its numeric value. */
...
/* Parse a width or number token from a format string in the given base. */
...
/* Emit a formatted field with optional zero-padding and minimum width. */
...
/* Core printf-style formatter shared by tfp_printf and tfp_sprintf. */
...
/* Install the active console output sink used by tfp_printf. */
...
/* Print one formatted string through the currently installed output sink. */
