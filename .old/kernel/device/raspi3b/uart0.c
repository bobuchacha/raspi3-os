...
/*
 * Try to receive one character without blocking.
 *
 * Returns:
 *   0 when a byte was available and stored in `out_char`.
 *  -1 when the UART receive FIFO is empty or the output pointer is null.
 */
