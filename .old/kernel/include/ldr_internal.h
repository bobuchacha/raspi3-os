...
struct LdrModuleStruct {
    ...
    /*
     * Dependency edges recorded after import binding.
     *
     * Each unique imported module is retained once here so unload can later
     * release it exactly once, independent of how many symbols were imported
     * from the same dependency.
     */
    PLDR_MODULE* dependencies;
