...
#define TABLE_DESCRIPTOR_ATTR PF_TYPE_TABLE     // for page table descriptor, bit 2:11 are ignored
...
//    memory_map_4k(0xFFFF000000FF0000ull, 0x00FF0000);
    ...
    unsigned long x = 0xDEADCABE12345678;
    ...
    printf("id_aa64mmfr0_el1: 0x%x; mair: 0x%x, mair2 0x%x\n", r, mair, MAIR_VALUE);
