//
// Created by Thang Cao on 5/24/24.
//

#include "mmu.h"

extern volatile unsigned char _data;        // start of data section
extern volatile unsigned char _end;         // start of end or heap memory
