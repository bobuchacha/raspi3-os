...
DLL_EXPORT(samplemath_add3);
DLL_EXPORT(samplemath_invocation_count);
DLL_EXPORT(samplemath_profile);
DLL_EXPORT(samplemath_set_name);
DLL_EXPORT(samplemath_get_name);
 ...
 */
int samplemath_entry(void* image_base, U32 reason) {
    (void)image_base;
 ...
 */
long samplemath_add3(long lhs, long rhs, long extra) {
 ...
 */
unsigned long samplemath_invocation_count(void) {
 ...
 */
const char* samplemath_profile(void) {
 ...
 */
long samplemath_set_name(const char* value) {
 ...
 */
const char* samplemath_get_name(void) {
    SampleMathSharedState* state = samplemath_shared_state();
