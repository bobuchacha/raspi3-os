...
// DLL_IMPORT_FUNCTION(DLLSMOKE_MODULE_NAME, "samplemath_add3", dllsmoke_add3_fn, g_dllsmoke_add3);
DLL_IMPORT_FUNCTION(DLLSMOKE_MODULE_NAME, "samplemath_invocation_count", dllsmoke_invocation_count_fn, g_dllsmoke_invocation_count);
DLL_IMPORT_FUNCTION(DLLSMOKE_MODULE_NAME, "samplemath_profile", dllsmoke_profile_fn, g_dllsmoke_profile);
DLL_IMPORT_FUNCTION(DLLSMOKE_MODULE_NAME, "samplemath_set_name", dllsmoke_set_name_fn, g_dllsmoke_set_name);
DLL_IMPORT_FUNCTION(DLLSMOKE_MODULE_NAME, "samplemath_get_name", dllsmoke_get_name_fn, g_dllsmoke_get_name);

DECLARE(long, add3, (long first_number, long second_number, long third_number), FROM, "samplemath.dll", "samplemath_add3");
...
int AppMain(void) {
    ...
    if (u64_to_hex((uint64_t)(uintptr_t)&AppMain, main_address, sizeof(main_address), 0) == 0) {
        (void)dllsmoke_write_value("dllsmoke.exe: AppMain address=", main_address);
    }
