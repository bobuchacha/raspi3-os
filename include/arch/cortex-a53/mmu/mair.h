...
#define _MAIR_CACHEABLE    (unsigned long long)(__MAIR_TRANSIENT | \
                    __MAIR_WRITE_BACK | \
...
#define MAIR_DEVICE     _MAIR_DEVICE_nGnRE                                              // 0x4

/* inner cacheable, outer cacheable */
#define MAIR_CACHEABLE  (_MAIR_CACHEABLE | (_MAIR_CACHEABLE << 4))                      // 0xF

/* inner non-cacheable, outer non-cacheable */
#define MAIR_NON_CACHEABLE    (_MAIR_NON_CACHEABLE | (_MAIR_NON_CACHEABLE << 4))        // 0x44
